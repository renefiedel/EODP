...
indir = '/home/renefiedel/PycharmProjects/EODP/Output/ism_output'
#  mytoa = readToa(indir, "l1b_toa_eq_VNIR-0.nc")

refoutdir = '/home/renefiedel/PycharmProjects/EODP_TER-20200917T082333Z-001/EODP_TER/EODP-TS-ISM/output'
#   reftoa = readToa(refoutdir, "l1b_toa_eq_VNIR-0.nc")

for ii in range(4):
    mytoa = readToa(indir, "ism_toa_VNIR-" + str(ii) + ".nc")
    reftoa = readToa(refoutdir, "ism_toa_VNIR-" + str(ii) + ".nc")
