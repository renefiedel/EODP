				...
				<xsl:for-each select="$XML">
					...
					<h2>
						<span style="font-weight:bold; ">
							<xsl:text>Attitude file with angles</xsl:text>
						</span>
						<span>
					...
					<xsl:for-each select="n1:Earth_Explorer_File">
						...
						<xsl:for-each select="n1:Data_Block">
							...
							<xsl:for-each select="n1:Attitude_Angles_Data">
								<xsl:for-each select="n1:List_of_Attitude_Angles">
									<br/>
									<br/>
									<h3>Attitude angles</h3>
									<br/>
									<table border="1" cellpadding="5" cellspacing="0">
										...
										<thead>
											<tr>
												...
												<th colspan="2">
													<span>
														<xsl:text>Yaw</xsl:text>
													</span>
												</th>
											</tr>
										</thead>
										<tbody>
											<xsl:for-each select="n1:Attitude_Angles">
												<tr>
