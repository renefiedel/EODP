		...
		if (node.nodeName.toLowerCase() == &quot;h3&quot;) {
			...
			<body onload="generateTOC(document.getElementById(&apos;toc&apos;));">
				<xsl:for-each select="$XML">
					...
					<h2>
						<span>
							<xsl:text>OSV list file (style sheet version 1.0)</xsl:text>
						</span>
					</h2>
					<xsl:for-each select="n1:Earth_Explorer_File">
						...
						<table border="1" cellpadding="5" cellspacing="0">
							...
							<tbody>
								<tr>
									<th>
										<span>
											<xsl:text>Ref_Frame</xsl:text>
										</span>
									</th>
									<xsl:for-each select="n1:Earth_Explorer_Header">
										<xsl:for-each select="n1:Variable_Header">
											<td>
												<xsl:for-each select="n1:Ref_Frame">
													<xsl:apply-templates/>
												</xsl:for-each>
											</td>
										</xsl:for-each>
						...
						<xsl:for-each select="n1:Data_Block">
							...
							<table border="1" cellpadding="5" cellspacing="0">
								...
								<tbody>
									<xsl:for-each select="n1:List_of_OSVs">
										<xsl:for-each select="n1:OSV">
											<tr>
												...
												<td>
													<xsl:for-each select="n1:Quality">
														<xsl:apply-templates/>
													</xsl:for-each>
												</td>
											</tr>
